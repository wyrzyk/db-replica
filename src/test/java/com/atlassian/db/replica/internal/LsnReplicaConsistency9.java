 ...
 */
@ThreadSafe
public class LsnReplicaConsistency9 implements ReplicaConsistency {
    private final Cache<LogSequenceNumber> lastWrite;

    public LsnReplicaConsistency9(Cache<LogSequenceNumber> lastWrite) {
        this.lastWrite = lastWrite;
    }

    public LsnReplicaConsistency9(){
